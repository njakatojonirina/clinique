...
<%
    ArrayList<Depense> liste = (ArrayList<Depense>) request.getAttribute("liste");
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            ...
                            <div class="col-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title"> New depense </h4>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <label class="col-sm-3 col-form-label">Nomdepense</label>
                                                        <div class="col-sm-9">
                                                            <input type='text' name='Nomdepense' class="form-control" required="" />
                                                        </div>
                                                    </div>
                                                </div> 
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr><td class="py-1">
                                                        ...
                                                        <td class="py-1">
                                                            <p><%=liste.get(i).getNomdepense()%></p>
                                                        </td>
                                                        <td>
                                                            <p>
                                                                <button type="button" class="btn btn-outline-success btn-icon-text" data-toggle="modal" data-target="#updatemodal" onclick="Update_Depense('<%=liste.get(i).getId()%>', '<%=liste.get(i).getNomdepense()%>')">
                                                        ...
                                                        <td>
                                                            <p>
                                                                <button type="button" class="btn btn-outline-danger btn-icon-text" data-toggle="modal" data-target="#deletemodal" onclick="delete_Depense('<%=liste.get(i).getId()%>')">
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    <form class="forms-sample" method="POST" action="<%=request.getContextPath()%>/UpdateGeneraliser">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="exampleInputUsername1">nomdepense</label>
                                                            <input type="text" class="form-control" name="Nomdepense" id="nomdepenseUpdate">
                                                        </div>
                                                        <input type="hidden" class="form-control" name="modele" value="<%=modele%>">
                                                        <input type="hidden" class="form-control" name="sql" value="<%=requete%>">
                                                        <button type="submit" class="btn btn-primary mr-2">Submit</button>
...
<script>
    function Update_Depense(id, nomdepense) {
        idUpdate.value = id
        nomdepenseUpdate.value = nomdepense
    }
