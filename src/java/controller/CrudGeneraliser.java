 ...
 */
@Controller
public class CrudGeneraliser {
    @Autowired
    private ServletContext servletContext;
    
    @RequestMapping(value="/listerGeneraliser")
    ...
    @RequestMapping(value="/newGeneraliser")
    ...
    @RequestMapping(value="/UpdateGeneraliser")
    ...
    @RequestMapping(value="/DeleteGeneraliser")
    ...
    @RequestMapping(value="/RechercheSimpleGeneraliser")
    ...
    @RequestMapping(value="/GenererPdfGeneraliser")
     public /*String*/ void GenererPdf(HttpServletRequest request,Model model,HttpServletResponse response) throws Exception{
        ...
        try {
            ...
            System.out.println("aaaaaaaaaaa erreur "+e.getMessage());*/
        }
        /*return vue;*/
    }
